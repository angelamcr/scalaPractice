...
import org.scalatestplus.junit.JUnitRunner
  ...
  class MakeChangeSuite extends FunSuite {
    ...
    test( "How many different ways can make I change of 0 dollars"){
      assert(makeChange(0) === 1)
    }

    test( "How many different ways can I make change of -10 dollars"){
      assert(makeChange(-10) === 0)
    }

    test( "How many different ways can I make change of 1 dollar"){
      assert(makeChange(1) === 292)
    }
